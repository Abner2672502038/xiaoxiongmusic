window.onload = function () {
    ...
    playBtn.onclick = function () {
        ...
        if (musicAudio.paused) {
            playBtn.style.backgroundImage='url(http://localhost:8080/img/播放.png)';

            musicAudio.play();

        } else {
            playBtn.style.backgroundImage = 'url(${pageContext.request.contextPath}/img/暂停.png)';
            musicAudio.pause();
        }
    };
    ...
    modeBtn.onclick = function () {
        if (musicAudio.loop) {
            ...
            this.style.backgroundImage = 'url(${pageContext.request.contextPath}/img/随机.png)';
        } else {
            musicAudio.loop = true;
            this.style.backgroundImage = 'url(${pageContext.request.contextPath}/img/单曲循环.png)';
        }
    };
